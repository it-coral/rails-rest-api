module Organizations
  module Relations
    ...
    included do
      ...
      has_many :addon_organizations
      has_many :addons, through: :addon_organizations
      has_many :addon_courses, through: :addons
      has_many :courses_from_addons, through: :addons, source: :courses
